...
class PMCPnP(dinv.sampling.MonteCarlo):
    def __init__(
        self, prior, data_fidelity, sigma, gamma, alpha, max_iter=1e3, thinning=1, burnin_ratio=0.4, clip=(-1, 1), verbose=True,
    ):
...
class PMCPnPAnnealing(dinv.sampling.MonteCarlo):
    def __init__(
        self, prior, data_fidelity, sigmas, gamma, alphas, max_iter=1e3, thinning=1, burnin_ratio=0.4, clip=(-1, 1), verbose=True,
    ):
        # generate an iterator
